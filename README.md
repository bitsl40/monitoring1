...
## Ответ:
CPU Usage: так как платформа вычислительная, это главный индикатор. Нужно видеть момент, когда CPU упирается в полку 
Disk Space Usage: Отчеты пишутся на диск, его переполнение приведет к полной остановке записи результатов и падению приложения
Disk I/O: чтобы убедиться, что запись тяжелых отчетов не создает очередь .
#
>2. Менеджер продукта посмотрев на ваши метрики сказал, что ему непонятно что такое RAM/inodes/CPUla. Также он сказал, 
что хочет понимать, насколько мы выполняем свои обязанности перед клиентами и какое качество обслуживания. Что вы 
можете ему предложить?
## Ответ:
Использовать следующие подходы при настройке мониторинга:
